...
var screenshots = '/WOrk/CasperJS programs/new/hcah/captures/';		

var url = 'http://showcase-pcs-admin.hcah.in/';
	...
	casper.test.begin("Suite -1 : Registering patient" ,0,function suite(test){		// suite consists of multiple test cases
		...
		casper.then(function(){
			...
			this.sendKeys('#username','somyajit');
			this.sendKeys('#password','admin123@');
